...
def load_settings(path: Path | None = None) -> Settings:
    ...
    return Settings(
        ...
        summary_model=raw.get("summary_model", "gemini-3.1-flash"),
        summary_fallback_model=raw.get("summary_fallback_model", "gemini-3.1-pro"),
        summary_mode=raw.get("summary_mode", "direct"),
        transcription_provider=raw.get("transcription_provider", "gemini"),
        transcription_model=raw.get("transcription_model", "gemini-3.1-flash"),
