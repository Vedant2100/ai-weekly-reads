...
- `weekly/latest.md` is the single public, tracked, summaries-only weekly book. Each build overwrites it; never include full transcripts, EPUBs, or private delivery data there.
